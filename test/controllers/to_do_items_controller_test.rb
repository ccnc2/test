...
class ToDoItemsControllerTest < ActionController::TestCase
  ...
  test "should create to_do_item" do
    assert_difference('ToDoItem.count') do
      post :create, to_do_item: { description: @to_do_item.description, due: @to_do_item.due, progress: @to_do_item.progress }
    end
  ...
  test "should update to_do_item" do
    patch :update, id: @to_do_item, to_do_item: { description: @to_do_item.description, due: @to_do_item.due, progress: @to_do_item.progress }
    assert_redirected_to to_do_item_path(assigns(:to_do_item))
  end
